  ...
  callWithJQuery(function ($) {
    ...
    aggregators = (function (tpl) {
      return {
        ...
        "Superiores a 80%": tpl.sumOverSumBound80(true, usFmt),
        "Abaixo de 80%": tpl.sumOverSumBound80(false, usFmt),
    ...
    renderers = {
      ...
      "Tabela Barchart": function (data, opts) {
        return $(pivotTableRenderer(data, opts)).barchart();
      },
      "Heatmap": function (data, opts) {
        return $(pivotTableRenderer(data, opts)).heatmap("heatmap", opts);
      },
      "Linha Heatmap": function (data, opts) {
        return $(pivotTableRenderer(data, opts)).heatmap("rowheatmap", opts);
      },
      "Coluna Heatmap": function (data, opts) {
    ...
    locales = {
      en: {
        ...
        renderers: renderers,
        localeStrings: {
          renderError: "Ocorreu um erro ao renderizar os resultados do PivotTable.",
          computeError: "Ocorreu um erro ao ao computar os resultados do PivotTable.",
          uiRenderError: "Ocorreu um erro ao renderizar o PivotTable UI.",
    ...
    $.fn.pivotUI = function (input, inputOpts, overwrite, locale) {
      ...
      try {
        ...
        fn1 = function (attr) {
          ...
          triangleLink = $("<span>").addClass('pvtTriangle').html("<big>&#x25BE;</big>").bind("click", function (e) {
            var left, ref2, top;
        ...
        refreshDelayed = (function (_this) {
          return function () {
            ...
            //$('#output.box-item').show();
            $('.pvtTable').fadeIn('slow');
        ...
        refresh = (function (_this) {
          return function () {
            //$('#output.box-item').attr('disabled','disabled');
            var load = $('<i id="load">').addClass('fa fa-circle-o-notch fa-spin').
            css({
              'z-index':'5',
              'position': 'absolute',
              'font-size':'80px'});
            ...
            load.hide();
            $('.pvtTable').fadeOut(500);
            $('td.pvtRendererArea').prepend(load);
            load.fadeIn('slow');
            
            
            return setTimeout(refreshDelayed, 800);
          };
        })(this);
        refresh();
