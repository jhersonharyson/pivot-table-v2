...
(function() {
  ...
  callWithJQuery(function($, c3) {
    ...
    return $.pivotUtilities.c3_renderers = {
      "Gráfico de Barra Horizontal": makeC3Chart({
        type: "bar",
        horizontal: true
      }),
      "Gráfico de Barras Empilhadas Horizontal": makeC3Chart({
        type: "bar",
        stacked: true,
        horizontal: true
      }),
      "Gráfico de Barra": makeC3Chart({
        type: "bar"
      }),
      "Gráfico de Barras Empilhadas": makeC3Chart({
        type: "bar",
        stacked: true
      }),
      "Gráfico de Linha": makeC3Chart(),
      "Gráfico de Área": makeC3Chart({
        type: "area",
        stacked: true
      }),
      "Grafico de Dispersão": makeC3Chart({
        type: "scatter"
      })
    };
  });
